...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   *
   * $state.go('advisor');
   * // Auto-populates list and item views with /partials/advisor/contact/list.html,
   * // and /partials/advisor/contact/item.html, respectively.
   * </pre>
   *
   ...
   *
   * @param {string} name A unique state name, e.g. "advisor", "about", "contacts".
   * To create a parent/child state use a dot, e.g. "about.sales", "advisor.newest".
   ...
   *     applying the current state
   *
   * <pre>templateUrl: "advisor.html"</pre>
   ...
   * // above "advisor" state.
   * $stateProvider.state("advisor.newest", {});
   *
   * // Nest states as deeply as needed.
   * $stateProvider.state("advisor.newest.abc.xyz.inception", {});
   *
 ...
 * following template:
 * <pre>
 * <a ui-sref="advisor">Home</a> | <a ui-sref="about">About</a> | <a ui-sref="{page: 2}">Next page</a>
 *
 * <ul>
 ...
 * <pre>
 * <a href="#/advisor" ui-sref="advisor">Home</a> | <a href="#/about" ui-sref="about">About</a> | <a href="#/contacts?page=2" ui-sref="{page: 2}">Next page</a>
 *
 * <ul>
 *     <li ng-repeat="contact in contacts">
 ...
 * </ul>
 *
 * <a ui-sref="advisor" ui-sref-opts="{reload: true}">Home</a>
 * </pre>
 *
